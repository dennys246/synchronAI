#!/bin/sh
SCRIPT_VERSION="pre_dinov2_features_bsub-v1"
...
bsub -J synchronai-dinov2-features-$DATE -oo $SYNCHRONAI_DIR/scripts/bsub/logs/synchronai_dinov2_features_$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/synchronAI/scripts/bsub/dinov2_features_bsub.sh
