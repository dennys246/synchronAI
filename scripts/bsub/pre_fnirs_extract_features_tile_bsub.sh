...
echo "=========================================="
echo "  [$SCRIPT_VERSION]  fNIRS Per-Pair Feature Extraction (TILE)"
echo "  Date: $DATE"
echo "=========================================="
...
submit_extraction() {
    ...
    bsub -J "synchronai-extract-tile-${MODEL_NAME}-$DATE" \
         ...
         -oo "$LOG_DIR/fnirs_extract_tile_${MODEL_NAME}_$DATE.log" \
