#!/bin/sh
SCRIPT_VERSION="pre_video_synchrony_bsub-v1"
...
bsub -J synchronai-video-synchrony-$DATE -oo $SYNCHRONAI_DIR/scripts/bsub/logs/synchronai_video_$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/synchronAI/scripts/bsub/video_synchrony_bsub.sh
