...
def generate_fnirs_diffusion(
    *,
    ...
    # Derive pair count from the model's actual output width, not the montage
    # metadata: per-pair models (feature_dim=2) emit ONE pair even though
    # pair_names lists the full montage. (20-ch: 20//2=10, unchanged.)
