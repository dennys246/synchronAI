...
if __name__ == "__main__":
    ...
    # 0.0 matches the TrainingConfig dataclass default (line 79) and main.py.
    # A non-zero default silently enabled the audio event auxiliary task, which
    # trains a 7-class head against binary sync labels when run as a script.
