...
def set_seed(seed: int, deterministic: bool = False) -> None:
    ...
    # NOTE: this does NOT affect the CURRENT interpreter's string hashing — that
    # is fixed at startup, so setting it here only propagates to CHILD processes
    # spawned afterward. Do NOT rely on it for split determinism: subject/video
    # splits sort groups before shuffling (sorted(set(...))) so they reproduce
    # across processes regardless of hash randomization. Kept for child procs.
